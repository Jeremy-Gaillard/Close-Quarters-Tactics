...
namespace CQT.Model
{
    class GameEnvironment
    {
        ...
        public void update()
        {
            ...
            viewLine2 = viewLine.rotate(Math.PI/5);
            ...
            //////
            Project(ref viewLine, viewLine2);
            ...
            //////
            ProjectReverse(newLeft, ref viewLine2);
        ...
        List<Line> Project(ref Line left, Line right, Line? ignoredWall = null)
        {
            ...
            if (wall != null)
            {
                ...
                if (Utils.angle(left.p1, p) < right.angle) //Utils.angle(right))
                {
                    ...
                    Line newLine = new Line(left.p1, p);
                    ProjectReverse(left, ref newLine, wall);
                    ...
                    //newLine = new Line(newLine.X1, newLine.Y1, newLine.X2, newLine.Y2);
                    Project(ref newLine, right, wall);
